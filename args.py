...
parser = argparse.ArgumentParser(description="for training on standard benchmarks")
...
parser.add_argument("--feature-maps", type=int, default=32, help="initial number of feature maps in first embedding, used as a base downstream convolutions")
parser.add_argument("--backbone", type=str, default="resnet12", help="backbone architecture")
...
parser.add_argument("--student_input_size", default=224, type=int, help="input size for the student model")
...
parser.add_argument('--teacher-model', type=str, default='dinov2_vits14')
parser.add_argument('--teacher-pretrained', type=str, default=None)
parser.add_argument('--student-model', type=str, default='mobilenet_v3_small')
...
parser.add_argument('--distill-type', type=str, default='mse', choices=['mse', 'kl', 'cosine'])
